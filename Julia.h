...
void Julia5(uint16_t size_x, uint16_t size_y, uint16_t offset_x, uint16_t offset_y, uint16_t zoom)
{
  ...
  for (y=0; y<size_y; y++)
  {
    for (x=0; x<size_x; x++)
    {
      ...
      Pixel(x,y,256-i*8,256-i*18,256-i*38);
    }
  }
}
